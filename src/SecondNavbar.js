    ...
    return(
        <div className="second-nav">
            <ul className="width1250 flex space-btw  opacity">
                    ...
                    <div className="width1250 dropdown-content">
                        <div className="flex space-btw ">
                            ...
                            <ul>
                                ...
                                <li>Semi Automatic Front Load</li>
                            </ul>
                            <ul>
                    ...
                    <div className="width1250 dropdown-content">
                        <div className="flex space-btw ">
                            ...
                            <ul>
                                ...
                                <li>Flats & Bellies</li>
                                <li>Sport Shoes</li>
                                <h4>Infant Footwear</h4>
                                <h4>Character Shoes</h4>
                                <li>Kids Watches</li>
                                <li>Kids Sunglasses</li>
                                <h4>Kids Winter Wear</h4>
                                <h4>Boys Winter Wear</h4>
                                <li>Boys Sweatshirts</li>
                                <li>Boys Jacket</li>
                                <h4>Girls Winter Wear</h4>
                    ...
                    <div className="width1250 dropdown-content">
                        <div className="flex space-btw ">
                            ...
                            <ul>
                                ...
                                <li>Table Lamp</li>
                                <li>Ceiling Lamp</li>
                                <li>Emergncy Lights</li>
                            </ul>
                            <ul>
                                <h4>Pet Supplies</h4>
                                <li>Dogs</li>
                                <li>Cats</li>
                                <li>Fishes & Aquatics</li>
                ...
                <li className="dropdown"><div className="dropbtn" role="button">Grocery</div></li>
            </ul>
        </div>
    )
}
